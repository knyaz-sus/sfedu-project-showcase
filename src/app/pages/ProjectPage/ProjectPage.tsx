      ...
      <div className="flex flex-col md:flex-row justify-between gap-4">
        ...
        <div className="flex-1 flex flex-col order-1 md:order-2  gap-2 items-start">
          ...
          <p>
            ...
            современных технологий и подходов к программированию.  <br />Фронтенд
            реализован на React с использованием TypeScript, что обеспечивает
            строгую типизацию и упрощает поддержку кода. Бэкенд построен на
            Node.js с использованием Express, что позволяет быстро обрабатывать
            запросы и предоставлять API для взаимодействия клиентских приложений
            с сервером.
